...
| 当前硬件 | STM32F103C8T6 Blue Pill、ST-Link V2、USB-TTL UART、SPI1 与 TB6612 已完成验证 |
...
| 最新更新 | 2026-08-10 — ISSUE-0025 TB6612 PWM Speed Control 验收通过 |
...
| [ISSUE-0025](issues/ISSUE-0025.md) | TB6612 PWM Speed Control | 已完成 | 电机启动、停止、周期运行和 PWM 控制验证通过 |
